...
namespace AES_C_SHARP
{
    class SEC_AES
    {
        ...
        //Mã hóa một mảng byte vào một mảng byte sử dụng một khoá và một phần tử IV
        private byte[] Encrypt(byte[] clearData, byte[] Key, byte[] IV)
        {

            // Create a MemoryStream that is going to accept the encrypted bytes 
            //Tạo một MemoryStream đó sẽ chấp nhận các byte mã hoá
        ...
        /// Trả về một chuỗi được mã hóa bằng Rijndael (128,192,256 Bits).
        /// </summary>
